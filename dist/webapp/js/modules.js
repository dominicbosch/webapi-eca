'use strict';
var deleteModule, editModule, fOnLoad, modName, sendStartStopCommand, start, startStopModule, strPublicKey, updateModules, updatePlayButton, urlService;
...
updateModules = function(uid) {
  ...
  req.done(function(arrModules) {
    ...
    if (arrModules.length === 0) {
      ...
      trNew.append('td').append('img').attr('class', 'icon edit').attr('src', '/images/edit.png').attr('title', 'Edit Module').on('click', editModule);
      if (oParams.m !== 'ad') {
